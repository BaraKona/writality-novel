...
export const DropdownMenuItem = withVariants(DropdownMenuPrimitive.Item, menuItemVariants, [
  'inset'
])
...
const dropdownMenuLabelVariants = cva(
  cn('mx-1 px-2 pt-1.5 pb-2 text-xs font-semibold text-muted-foreground select-none'),
  {
    variants: {
      inset: {
        true: 'pl-8'
