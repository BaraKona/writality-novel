...
import { ParagraphPlugin, useEditorPlugin, useStoreSelect } from '@udecode/plate/react'
import { CheckIcon, XIcon } from 'lucide-react'

import { suggestionPlugin } from '@renderer/components/editor/plugins/suggestion-plugin'

import { Avatar, AvatarFallback, AvatarImage } from './avatar'
import { type TDiscussion, discussionStore, useFakeUserInfo } from './block-discussion'
...
export const useResolveSuggestion = (
  ...
  const discussions = useStoreSelect(discussionStore, (state) => state.discussions)
