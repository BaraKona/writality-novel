...
import type { PlateRenderElementProps, RenderNodeWrapper } from '@udecode/plate/react'
...
import { useEditorPlugin, useEditorRef, usePluginOption, useStoreValue } from '@udecode/plate/react'
import { MessageSquareTextIcon, MessagesSquareIcon, PencilLineIcon } from 'lucide-react'

import {
  type CommentsConfig,
  commentsPlugin
} from '@renderer/components/editor/plugins/comments-plugin'
import { suggestionPlugin } from '@renderer/components/editor/plugins/suggestion-plugin'
import { Button } from '@renderer/components/plate-ui/button'
import {
  Popover,
  PopoverAnchor,
  PopoverContent,
  PopoverTrigger
} from '@renderer/components/plate-ui/popover'
...
const BlockCommentsContent = ({
  ...
  const activeSuggestion =
    activeSuggestionId && resolvedSuggestion.find((s) => s.suggestionId === activeSuggestionId)
