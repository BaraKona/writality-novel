...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <>
      {!open && (
        <Separator orientation="vertical" className={`h-4 ${open ? '' : 'ml-[4.5rem]'} `} />
      )}
      <Button
        ref={ref}
      ...
      >
        {open ? (
          <>
            <AlignJustify className="block group-hover:hidden" strokeWidth={1.5} />
            <ChevronsLeft className="hidden group-hover:block" strokeWidth={1.5} />
          </>
        ) : (
          <>
            <ChevronsRight className="hidden group-hover:block" strokeWidth={1.5} />
            <AlignJustify className="block group-hover:hidden" strokeWidth={1.5} />
          </>
        )}
