...
const api: Operations = {
  ...
  updateProject: async (project: Project) =>
    await ipcRenderer.invoke("updateProject", project),
  ...
  updateFolder: async (folder: any) =>
    await ipcRenderer.invoke("updateFolder", folder),
  deleteFolder: async (id: number) =>
    await ipcRenderer.invoke("deleteFolder", id),
  getFolderById: async (id: number) =>
    await ipcRenderer.invoke("getFolderById", id),
  getFolderTree: async (folderId: number) =>
    await ipcRenderer.invoke("getFolderTree", folderId),
  ...
  updateChapter: async (chapter: any) =>
    await ipcRenderer.invoke("updateChapter", chapter),
  getChapterById: async (id: number) =>
    await ipcRenderer.invoke("getChapterById", id),
